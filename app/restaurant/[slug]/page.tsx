            ...
            <div className="max-w-screen-2xl m-auto bg-white">
              {/* NAVBAR */}
                <nav className="bg-white p-2 flex justify-between">
                  <Link href="/" className="font-bold text-gray-700 text-2xl">Restaurant</Link>
                  <div>
                    <div className="flex">
                    ...
                    <div className="bg-white w-[70%] rounded p-3 shadow">
                      {/* RESAURANT NAVBAR */}
                        <nav className="flex text-reg border-b pb-2">
                          <Link href="/restaurant/any" className="mr-7"> Overview </Link>
                          <Link href="/restaurant/any/menu/" className="mr-7"> Menu </Link>
                        </nav>
                      {/* RESAURANT NAVBAR */} 
                      {/* TITLE */}
